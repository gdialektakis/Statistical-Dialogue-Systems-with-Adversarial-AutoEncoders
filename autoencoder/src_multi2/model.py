...
class Autoencoder(object):
    ...
    def __init__(self, domainString, policyType):
        ...
        self.domainIndices = cfg['domain_indices'][domainString]
    ...
    def encoder(self, X):
        ...
        Y = tf.nn.relu(tf.matmul(X, W[self.domainIndices[0]:self.domainIndices[1], :]))
    ...
    def decoder(self, Y):
        ...
        W = get_weight_variable('W0')
        X = tf.nn.relu(tf.matmul(X, tf.transpose(W[self.domainIndices[0]:self.domainIndices[1], :])))
