...
class Autoencoder(object):
        ...
        with tf.variable_scope("autoencoder_" + variable_scope_name, reuse=tf.AUTO_REUSE):
            ...
            if cfg['restore_model']:
                try:
                    ...
                    print("Variables restored for "+domainString+' SAE ' + str(self.layers_shape))
                except:
                    print("Variables restore Failed for "+domainString+' SAE!')
                    pass
    ...
    def KL_Divergence(self):
        return self.rho * tf.log(self.rho / self.rho_hat) + (1 - self.rho) * tf.log(
            (1 - self.rho) / (1 - self.rho_hat))
