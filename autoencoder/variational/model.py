...
"""
Variational Model Fully connected Dense
"""
...
class Autoencoder(object):
        ...
        with tf.variable_scope("autoencoder_" + variable_scope_name, reuse=tf.AUTO_REUSE):
            ...
            if cfg['restore_model']:
                try:
                    ...
                    print("Variables restored for "+domainString+' AE ' + str(self.layers_shape))
                except:
    ...
    def save_learning_rate(self, dstring, learning_rate):
        with open(dstring + '_vae_learning_rate_logs.csv', 'a+') as csvfile:
            writer = csv.writer(csvfile, delimiter=',')
            writer.writerow([learning_rate])

    def load_learning_rate(self, dstring, learning_rate_params):
        with open(dstring + '_vae_learning_rate_logs.csv', 'r+') as csvfile:
