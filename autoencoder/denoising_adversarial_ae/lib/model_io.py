...
def get_configuration(domainString, policyType):
    config_filename = os.path.join('.', 'autoencoder', 'config',  'config_params_daae.json')
    ...
    return cfg, optim_params['learning_rate_method'][cfg['learning_rate_method']], \
           optim_params['optimization_algorithm'][cfg['optimization_algorithm']]
